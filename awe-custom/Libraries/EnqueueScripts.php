...
class EnqueueScripts
{
    ...
    public function _registerScripts()
    {
        ...
        $this->addStyle('custom-css', asset('css/custom.css'), true, true);//-- custom by ohteamvn
        ...
        if(file_exists(base_path('awe-custom/Assets/css/awe-custom.css'))){
            $this->addStyle('awe-custom', asset('awe-custom/Assets/css/awe-custom.css'), false, true);
        }

        if(file_exists(base_path('awe-custom/Assets/js/awe-custom.js'))){
