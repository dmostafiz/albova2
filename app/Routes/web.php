...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale']], function () {
    ...
    Route::get('auth-activities', 'AuthActivitiesController@index')->name('auth-activities');
    ...
    Route::post('reset-api-key', 'APIController@_resetApiKey')->name('reset-api-key');
});
...
// Notification
    ...
    Route::get('/', 'HomePageController@_experiencePage')->name('experience-demo');//--custom by ohteamvn
