...
$card_data = get_booking_data($booking->ID, 'cartData');
start_get_view();
?>
    ...
    <div class="content-email">
        ...
        <div class="booking-detail">
            ...
            @if($service_data->booking_type == 'package')
                <div class="item">
                    <span class="title">{{__('Package:')}}</span>
                    <span class="info">{{ get_translate($card_data['package']['title']) }}</span>
                </div>
            @endif
            <div class="item">
            ...
            <div class="item">
                ...
                <div class="info">
                    ...
                    <ul class="cart-list">
                        ...
                        @if($service_data->booking_type == 'date_time')
                            <li>
                                <span>{{__('Time')}}</span>
                                <span>
                                {{ date(hh_time_format(), $checkIn) }}
                            </span>
                            </li>
                        @endif
                        @if ($adults > 0)
