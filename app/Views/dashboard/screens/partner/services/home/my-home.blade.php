...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('My Homes')])
            {{--Start Content--}}
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0 title-overflow">
                                                <a class="text" href="{{ get_home_permalink($homeID, $item->post_slug) }}"
                                                    target="_blank">{{ get_translate($item->post_title) }}</a>
                                                <span class="text-muted d-none d-md-inline-block"> - {{ $homeID }}</span>
                                            </h5>
                                            <span
                                    ...
                                    <div class="dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item hh-link-action hh-link-duplicate-home"
                                               data-action="{{ dashboard_url('duplicate-home') }}"
                                               data-parent="tr"
                                               data-is-delete="false"
                                               data-params="{{ base64_encode(json_encode($data)) }}"
