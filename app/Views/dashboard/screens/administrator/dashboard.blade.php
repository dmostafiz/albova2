            ...
            <div class="earning-section">
                <div class="row">
                    <div class="d-block col-6 d-sm-none">
                        <p><span class="font-14">{{__('Balance:')}} <span
                                    class="font-16">{{ convert_price($earning['balance'], false) }}</span></span></p>
                    </div>
                    <div class="d-block col-6 d-sm-none">
                        <p><span class="font-14">{{__('Net Earning:')}} <span
                                    class="font-16">{{ convert_price($earning['net_amount'], false) }}</span></span></p>
                    </div>
                    <div class="d-block col-6 d-sm-none">
                        <p><span class="font-14">{{__('Earning:')}} <span
                                    class="font-16">{{ convert_price($earning['amount'], false) }}</span></span></p>
                    </div>
                    <div class="d-block col-6 d-sm-none">
                        <p><span class="font-14">{{__('Payout:')}} <span
                                    class="font-16">{{ convert_price($earning['payout'], false) }}</span></span></p>
                    </div>
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-payout">
                            <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               data-placement="bottom" title=""
                               data-original-title="{{__('The total of withdrawals')}}"></i>
            ...
            <div class="card-box">
                ...
                <div class="hh-slimscroll" data-max-height="350px">
                    ...
                    <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                           data-pdf="off" data-pdf-name="{{__('Export PDF')}}"
                           data-paging="false"
                           data-ordering="false">
                        <thead>
                        <tr>
