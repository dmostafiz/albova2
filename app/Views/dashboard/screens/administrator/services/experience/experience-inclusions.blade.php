...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Experience Inclusions')])
            {{--Start Content--}}
            <?php
            ...
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('All Inclusions')}}</h4>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-experience-inclusions-modal">{{__('Edit')}}</a>
            ...
            <div id="hh-update-experience-inclusions-modal" class="modal fade hh-get-modal-content" tabindex="-1"
                 role="dialog" aria-hidden="true"
                 data-url="{{ dashboard_url('get-term-item/experience-inclusions') }}">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Update Inclusion')}}</h4>
