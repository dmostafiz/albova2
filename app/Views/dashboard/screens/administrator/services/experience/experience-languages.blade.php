...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Experience Languages')])
            {{--Start Content--}}
            <?php
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-experience-languages-modal">{{__('Edit')}}</a>
            ...
            <div id="hh-update-experience-languages-modal" class="modal fade hh-get-modal-content" tabindex="-1"
                 role="dialog" aria-hidden="true"
                 data-url="{{ dashboard_url('get-term-item/experience-languages') }}">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Update Language')}}</h4>
