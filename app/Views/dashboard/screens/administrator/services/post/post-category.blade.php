...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Categories')])
            {{--Start Content--}}
            <?php
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                        ...
                        @foreach ($allTerms['results'] as $item)
                            <tr>
                                <td class="align-middle">
                                    <h5 class="m-0">
                                        <a href="{{ get_term_link($item->term_name) }}" target="_blank">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-post-categories-modal">{{__('Edit')}}</a>
                    ...
                    @else
                        <tr>
                            <td colspan="3">
                                <h4 class="mt-3 text-center">{{__('No categories yet.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
            ...
            <div id="hh-update-post-categories-modal" class="modal fade hh-get-modal-content" tabindex="-1"
                 role="dialog" aria-hidden="true"
                 data-url="{{ dashboard_url('get-post-category-item') }}">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Update Category')}}</h4>
