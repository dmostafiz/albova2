...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Car Type')])
            {{--Start Content--}}
            <?php
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-car-types-modal">{{__('Edit')}}</a>
                    ...
                    @else
                        <tr>
                            <td colspan="3">
                                <h4 class="mt-3 text-center">{{__('No terms yet.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
            ...
            <div id="hh-update-car-types-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog"
                 aria-hidden="true"
                 data-url="{{ dashboard_url('get-term-item/car-type') }}">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Update Car Type')}}</h4>
