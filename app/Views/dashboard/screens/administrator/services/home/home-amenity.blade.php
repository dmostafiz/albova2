...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Home Amenity')])
            {{--Start Content--}}
            <?php
            ...
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('All Amenities')}}</h4>
                    ...
                    @if ($allTerms['total'])
                        @foreach ($allTerms['results'] as $item)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <?php
                                    $icon = !empty($item->term_icon) ? get_icon($item->term_icon) : '';
                                    ?>
                                    @if($icon)
                                        <p class="mb-0">
                                            {!! $icon !!}
            ...
            <div id="hh-update-home-amenity-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog"
                 aria-hidden="true"
                 data-url="{{ dashboard_url('get-term-item/home-amenity') }}">
