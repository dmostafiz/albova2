    ...
    <div class="content">
        ...
        <div class="clearfix">
            ...
            <div class="prices">
                ...
                @if($currency['position'] == 'left'){{$currency['symbol']}}@endif
                <span class="price" data-hh-bind-from="#price_categories-price-adult"
                      data-hh-bind-default="0">0</span>
                @if($currency['position'] == 'right'){{$currency['symbol']}}@endif
